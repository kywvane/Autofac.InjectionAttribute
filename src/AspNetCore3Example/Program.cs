...
namespace AspNetCore3Example
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            hostbuild = hostbuild.UseServiceProviderFactory(new AutofacServiceProviderFactory());
            hostbuild = hostbuild.ConfigureWebHostDefaults(webHostBuilder => webHostBuilder.UseStartup<Startup>());
